...
public class MoveAlgorithm implements Constants, Serializable {
	...
	private Vector getKingMoves(Coord c) {
		...
		if (board.b[c.x][c.y].white) {
			if (c.x == 4 && c.y == 0 && !isAttacked(new Coord(4, 0), false)) {
				// Short
				if (board.b[5][0] == null && !isAttacked(new Coord(5, 0), false) && board.b[6][0] == null && !isAttacked(new Coord(6, 0), false) && board.b[7][0] != null && board.b[7][0].type == TYPE_ROOK && board.b[7][0].white)
					v.add(new Move(4, 0, 6, 0));
				// Long
				if (board.b[3][0] == null && !isAttacked(new Coord(3, 0), false) && board.b[2][0] == null && !isAttacked(new Coord(2, 0), false) && board.b[1][0] == null && board.b[0][0] != null && board.b[0][0].type == TYPE_ROOK && board.b[0][0].white)
					v.add(new Move(4, 0, 2, 0));
			}
		} else {
			if (c.x == 4 && c.y == 7 && !isAttacked(new Coord(4, 7), true)) {
				// Short
				if (board.b[5][7] == null && !isAttacked(new Coord(5, 7), true) && board.b[6][7] == null && !isAttacked(new Coord(6, 7), true) && board.b[7][7] != null && board.b[7][7].type == TYPE_ROOK && !board.b[7][7].white)
					v.add(new Move(4, 7, 6, 7));
				// Long
				if (board.b[3][7] == null && !isAttacked(new Coord(3, 7), true) && board.b[2][7] == null && !isAttacked(new Coord(2, 7), true) && board.b[1][7] == null && board.b[0][7] != null && board.b[0][7].type == TYPE_ROOK && !board.b[0][7].white)
	...
	private void testSpeed() {
		...
		if (stamp1 == null)
			...
			long millisec = milliDiff - (seconds * 1000);
			stamp1 = stamp2 = null;
			...
			System.out.println(empty.substring(0, col1Width - col1.length()) + col1 + empty.substring(0,
					col2Width - col2.length()) + col2 + empty.substring(0, col3Width - col3.length()) + col3);

			// Table values (right justified)
			System.out.println(empty.substring(0, col1Width - (dd + "").length()) + dd + empty.substring(0,
					col2Width - (stepcounter + "").length()) + stepcounter + empty.substring(0,
					col3Width - (val + "").length()) + val);
		}
	}
}
