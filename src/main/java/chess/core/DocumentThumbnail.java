...
import chess.gui.board.ChessBoardSmallView;
...
public class DocumentThumbnail extends JPanel {
	...
	private final ChessGame chessGame; // the chess game
	private final ChessBoard board;    // ChessBoardSmallView

	private final JPanel center;
	private final JPanel header; // thumbnail header
	private final JLabel label;  // header label
	private final JButton exit;  // exit button

	private final Dimension maxSize; // maximized thumbnail size
	private final Dimension minSize; // minimized thumbnail size
	private boolean minimized = false; // is minimized ?
	private boolean selected = true;   // is selected ?

	private int gIndex; // game index

	private final InfoLabel infoLabel; // game info
