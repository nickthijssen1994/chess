...
public class BoardParameters /*extends Parameters*/ implements Constants, Serializable {
	...
	public static final Object[] FACTORY_SETTINGS = {"board.primaryCell", new Color(80, 124, 224), "board" +
			".alternateCell", new Color(167, 191, 246),};
	...
	private final String primaryCellName = "board.primaryCell";
	private final String alternateCellName = "board.alternateCell";
	private final boolean willPieceDragCenter = true;
	private final boolean willPieceSlide = true;
	private final boolean allowPieceDrag = true;
