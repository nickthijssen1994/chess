...
public class PreferencesDialog extends JDialog {
	...
	private void addBoardTab() {
		...
		JScrollPane movePane = new JScrollPane(moveInputList, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	private void buildGUI() {
		...
		Object[] listData = {new priLabel(generalTab.getName()),
				...
				//new altLabel("Chat"),
				//new altLabel("Proxy"),
				new priLabel(boardTab.getName()), new altLabel(chessSetTab.getName())};
	...
	class priLabel extends JPanel {
		...
		private final Font pri = new FontUIResource("SansSerif", Font.BOLD, 15);
	...
	class altLabel extends JPanel {
		...
		private final Font alt = new FontUIResource("SansSerif", Font.PLAIN, 12);
		private final String name;
