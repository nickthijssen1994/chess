...
public class ToggleButtonUI extends MetalToggleButtonUI {
	 ...
	 */
	private static final ToggleButtonUI buttonUI = new ToggleButtonUI();
	...
	public static final void drawHighlight(Graphics graphics, Rectangle rectangle) {
		...
		GradientPaint g = new GradientPaint(rectangle.x, rectangle.y, Color.WHITE, rectangle.width, rectangle.height,
				Color.GRAY, false);
