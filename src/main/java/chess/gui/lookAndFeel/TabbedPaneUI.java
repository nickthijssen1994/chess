...
public class TabbedPaneUI extends BasicTabbedPaneUI {
	...
	private final Color outerHighlight = MyLookAndFeel.getControlDisabled();
	private final Color innerHighlight = MyLookAndFeel.getPrimaryControlHighlight();
	private final Color outerShadow = MyLookAndFeel.getControlDarkShadow();
	private final Color innerShadow = MyLookAndFeel.getDesktopColor();
