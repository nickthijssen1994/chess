...
public class DefaultTheme extends DefaultMetalTheme {
	...
	private final FontUIResource plainFont = new FontUIResource("SansSerif", Font.PLAIN, 12);
	private final FontUIResource boldFont = new FontUIResource("SansSerif", Font.PLAIN, 12);
