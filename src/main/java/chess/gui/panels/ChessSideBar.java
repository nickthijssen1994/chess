...
public class ChessSideBar extends JPanel {
	...
	private final Notation notationPanel;
	...
	class Info extends JPanel {
		...
		private final JProgressBar progressWhite;
		private final JProgressBar progressBlack;
		...
		public Notation() {
			...
			moves.addMouseMotionListener(new MouseMotionAdapter() {
				...
				public void mouseDragged(MouseEvent e) {
					...
					if (col == 0 || (moves.getValueAt(row, col) == null) || moves.getValueAt(row, col).equals("")) {
						return;
					} else {
						moves.removeEditor();
			...
			listScroller = new JScrollPane(movesPanel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
					JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
