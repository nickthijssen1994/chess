...
public class ChessChat implements ActionListener {
	 ...
	 */
	public ChessChat(Socket opponent, JEditorPane chatPane, JTextField textInput, String userName) {
		...
		htmlPane.setText("<pre><font face=\"" + font + "\">Welcome to Chess Chat" + "</font><pre>");
	}
	...
	public void receive(String msg) {
		...
		last = last.substring(last.indexOf("<pre>") + 5, last.lastIndexOf("</pre>"));

		// update the html pane with the message (some clever html parsing)
		htmlPane.setText("<pre>" + last + "\n<font color=\"" + opponentColor + "\" face=\"" + font + "\">" + username + ":</font><font face=\"" + font + "\">" + message + "</font></pre>");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		String last = htmlPane.getText();
		last = last.substring(last.indexOf("<pre>") + 5, last.lastIndexOf("</pre>")).trim();

		// some clever html parsing...
		String fontTag = "<font face=\"" + font + "\">";

		htmlPane.setText("<pre>" + last + "\n<font color=\"" + localColor + "\" face=\"" + font + "\">" + userHandle + ":</font><font face=\"" + font + "\">" + chatInput.getText() + "</font></pre>");
